                    ...
                    <li><a href="#">Action</a>
                        ...
                        <div class="panel-body">
                            <div class="row">
                              ...
                              <form>
                                <div class="col-lg-4"><label>Select Customer to View Transaction History: </label>
                                    <select class="form-control" name="userName">
                                      <option value ="je0k">je0k</option>
                                    ...
                                    <input type="submit" name="action" value="Select Customer" class="btn btn-outline btn-primary"/>
                                </div>
                              </form>
                              </div>
                              <br>
