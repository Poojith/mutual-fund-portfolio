                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                               ...
                               <input type="submit" value="Customer login" name="action" class="btn btn-outline btn-primary"/>
                               <input type="submit" value="Employee login" name="action" class="btn btn-outline btn-primary"/>
                            </fieldset>
                        </form>
                    </div>
                </div>
